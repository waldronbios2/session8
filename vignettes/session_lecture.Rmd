...
3. Explain and perform stratified analysis and its use
4. Explain time-dependent covariates and when to use them
...
5. Stratification
6. Propensity Score analysis to control for confounding
7. Immortal time bias in observational studies
...
* an alternative to multivariate regression to control for hypothesized confounders
* continue zzz
